...
INSERT INTO `teams` (team_id, `name`, shooting_accuracy, `goals`, passing_accuracy, `assists`, `save`, tackle_success, `yellow_card`, `red_card`, `remember_token`, `created_at`, `updated_at`)
VALUES
